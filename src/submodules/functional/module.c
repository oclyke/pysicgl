...
static PyObject* gamma_correct(PyObject* self, PyObject* args) {
  ...
  // if (!PyArg_ParseTuple(
  //         args, "O!O!", &InterfaceType, &input, &InterfaceType,
  //         &output)) {
  //   return NULL;
  // }
...
static PyObject* get_pixel_at_offset(PyObject* self, PyObject* args) {
  ...
  color_t color;
  int ret = sicgl_interface_get_pixel_offset(&interface_obj->interface, offset, &color);
  if (0 != ret) {
    PyErr_SetNone(PyExc_OSError);
    return NULL;
  }
...
static PyObject* get_pixel_at_coordinates(PyObject* self, PyObject* args) {
  ...
  ext_t u;
  ext_t v;
  if (!PyArg_ParseTuple(args, "O!(ii)", &InterfaceType, &interface_obj, &u, &v)) {
    return NULL;
  }
