...
PyObject* global_pixel(PyObject* self_in, PyObject* args) {
  ...
  int ret = sicgl_global_pixel(
      &self->interface, color, u, v);
  if (0 != ret) {
...
PyObject* global_line(PyObject* self_in, PyObject* args) {
  ...
  ext_t u0, v0, u1, v1;
  if (!PyArg_ParseTuple(
          args, "O!i(ii)(ii)", &color, &u0, &v0, &u1, &v1)) {
    return NULL;
  }

  int ret = sicgl_global_line(
      &self->interface, color, u0, v0, u1, v1);
  if (0 != ret) {
    PyErr_SetNone(PyExc_OSError);
    return NULL;
  }
...
PyObject* global_rectangle(PyObject* self_in, PyObject* args) {
  ...
  int ret = sicgl_global_rectangle(
      &self->interface, color, u0, v0, u1, v1);
  if (0 != ret) {
    PyErr_SetNone(PyExc_OSError);
    return NULL;
...
PyObject* global_circle(PyObject* self_in, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(
          args, "O!i(ii)(ii)", &color, &u0, &v0, &diameter)) {
    return NULL;
  }

  int ret = sicgl_global_circle_ellipse(
      &self->interface, color, u0, v0,
      diameter);
  if (0 != ret) {
    PyErr_SetNone(PyExc_OSError);
    return NULL;
...
PyObject* global_ellipse(PyObject* self_in, PyObject* args) {
  ...
  int ret = sicgl_global_ellipse(
      &self->interface, color, u0, v0, semiu, semiv);
  if (0 != ret) {
    PyErr_SetNone(PyExc_OSError);
    return NULL;
  }
